---
title: ROS Workspace
description: Overview of the ROS2 package structure and build system used in this simulation project.
---
...
Robot-specific packages follow the `<robot>_description` + `<robot>_bringup` convention. These are generated by [genbot](./genbot).
