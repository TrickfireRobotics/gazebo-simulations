...
Each robot has two packages, generated by [sim create](../../guides/adding-robots/):
...
**Unexplained build errors:** Run `sim clean` and rebuild. This fixes the majority of mysterious failures.
