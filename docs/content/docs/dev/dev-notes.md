...
**Stale build artifacts:** If something breaks for no obvious reason, run `./scripts/ros-clean.sh` and rebuild. Colcon's incremental builds can get confused after certain types of changes.
